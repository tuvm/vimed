  ...
  theme: {
    ...
    colors: {
      ...
      primary: {
        lighter: '#e4f6fa',
        light: '#39C2D7',
        main: '#427A99', // Primary / primary200s
        dark: '#2C5166', // Primary / primary400s
        active: '#39C2D7',
        200: '#427A99',
        300: '#376580',
        400: '#2C5166',
    ...
    boxShadow: {
      ...
      DEFAULT: '0px 4px 4px rgb(21 34 46 / 25%), inset 0px -1px 0px #132b37',
      md: '0px 4px 4px rgb(21 34 46 / 25%), inset 0px -1px 0px #132b37',
      lg: '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
      xl: '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
      '2xl': '0 25px 50px -12px rgba(0, 0, 0, 0.25)',
      inner: 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.06)',
      outline: '0 0 0 3px rgba(66, 153, 225, 0.5)',
      light: 'inset 0px -1px 0px #e2e8f0',
      none: 'none',
    },
    container: {},
    cursor: {
